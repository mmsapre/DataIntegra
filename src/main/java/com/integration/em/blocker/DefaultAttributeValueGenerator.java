...
public class DefaultAttributeValueGenerator extends BlockingKeyGenerator<Record, MatchableValue, Attribute> {
	...
	@Override
	public void mapRecordToKey(Pair<Record, Processable<Aligner<MatchableValue, Matchable>>> pair, DataIterator<Pair<String, Pair<Attribute, Processable<Aligner<MatchableValue, Matchable>>>>> resultCollector) {
