...
//    private HashMap<Integer, Pair<String, Double>> mappedInstances = new HashMap<>();
    ...
    public static TblMapping read(String fileName) throws IOException {
        TblMapping m = new TblMapping();
